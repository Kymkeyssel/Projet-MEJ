...
const samplePhotos = [
  { id: 1, src: heroImage, title: "Réunion communautaire", category: "Événements" },
  { id: 2, src: projectDev, title: "Projet développement", category: "Projets" },
  { id: 3, src: projectHealth, title: "Sensibilisation santé", category: "Santé" },
  { id: 4, src: heroImage, title: "Assemblée générale", category: "Gouvernance" },
            ...
            {selectedPhoto !== null && selectedPhotoData && (
              ...
              >
                ...
                <div className="absolute bottom-8 left-1/2 -translate-x-1/2 text-center">
                  <p className="text-card font-heading font-semibold">{selectedPhotoData.title}</p>
                  <p className="text-card/70 text-sm">{selectedPhotoData.category}</p>
                </div>
              </motion.div>
            )}
          </AnimatePresence>
