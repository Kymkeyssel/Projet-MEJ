...
import footerBg from "../assets/Equipe de la MEJ sur le terrain à Baleveng pour une campagne de santé eu Festival MEKONG.jpeg";
  ...
  return (
    <footer className="relative bg-accent text-accent-foreground overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        />
        {/* <div className="absolute inset-0 bg-gradient-to-b from-accent/95 via-accent/80 to-accent" /> */}
      </div>
